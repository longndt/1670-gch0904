...
namespace web3.Controllers
{
    public class LaptopsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Quantity,BestSeller")] Laptop laptop)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Quantity,BestSeller")] Laptop laptop)
        {
            if (id != laptop.Id)
            {
                return NotFound();
