...
namespace web3.Controllers
{
    public class MobilesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Quantity,Price,Color,Image")] Mobile mobile)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Quantity,Price,Color,Image")] Mobile mobile)
        {
            if (id != mobile.Id)
            {
                return NotFound();
